...
| `x402:authorize` | Authorize x402/MPP payments on behalf of user |
| `x402:address` | Read user's payment wallet address |
| `x402:limits` | Manage per-agent spending limits |
