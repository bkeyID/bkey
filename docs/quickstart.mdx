...
- [Agent Payments](/guides/agent-payments) — let your agent pay for APIs (auto-detects x402 vs MPP)
- [CIBA Deep Dive](/authentication/ciba) — understand the core approval flow
- [Encryption](/guides/encryption) — what protects each step, end-to-end
- [MCP Integration](/guides/mcp-integration) — gate MCP tool calls with biometric approval
